...
outm1 <- jags(data = datm1, parameters.to.save = c("beta","b","y2"), inits = initsm1, 
              model.file = "FinalModels/cerwm1.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)

#Full Deviance
m1_yp <- outm1$mean$y2
m1_yt <- c(dat1$cerwdet[79510:88726], dat1$cerwtot[88727:95456], dat1$cerwdet[95457:103729])
m1_yt <- cbind(m1_yt, c(1 - dat1$cerwdet[79510:88726], 5 - dat1$cerwtot[88727:95456], 1 - dat1$cerwdet[95457:103729]))
...
Em1_yt <- c(dat1$cerwdet[79510:88726])
Em1_yt <- cbind(Em1_yt, c(1 - dat1$cerwdet[79510:88726]))
Em1_yp <- 0.0001 + Em1_yp*0.9998
Em1_dev <- -2*sum(log((Em1_yp^Em1_yt[,1])*((1-Em1_yp)^(Em1_yt[,2]))))
#BBA deviance
Am1_yp <- outm1$mean$y2[9218:15947]
Am1_yt <- c(dat1$cerwtot[88727:95456])
Am1_yt <- cbind(Am1_yt, c(5 - dat1$cerwtot[88727:95456]))
Am1_yp <- Am1_yp/5
Am1_yp <- 0.0001 + Am1_yp*0.9998
Am1_dev <- -2*sum(log((Am1_yp^Am1_yt[,1])*((1-Am1_yp)^(Am1_yt[,2]))))
#BBS deviance
Sm1_yp <- outm1$mean$y2[15948:24220]
Sm1_yt <- c(dat1$cerwdet[95457:103729])
Sm1_yt <- cbind(Sm1_yt, c(1 - dat1$cerwdet[95457:103729]))
...
save(outm1, m1, m1_dev, Em1_dev, Am1_dev, Sm1_dev, 
     file = "FinalResults/cerwm1.RData")

brier1 <- mean((outm1$mean$y2[9218:24220] - dat1$cerwdet[88727:103729])^2)

pred1 <- prediction(as.numeric(outm1$mean$y2[9218:24220]), dat1$cerwdet[88727:103729])
auc1 <- performance(pred1, measure = "auc")
auc1 <- auc1@y.values[[1]]

#roc1 <- roc(dat1$cerwdet[88642:103748], as.numeric(outm1$mean$y2[9218:24220]), ci.auc=TRUE, auc=TRUE, parallel=TRUE)

#Sim2Jam
require(rjags)
jm1 <- jags.model("FinalModels/cerwm1.txt", data=datm1, inits=initsm1, n.adapt=500, n.chains=3)
update(jm1, 500)
sam1 <- jags.samples(jm1, c("b","rho"), n.iter=2000, thin=2)
jam1 <- sim2jam(sam1, m1$pregam)

save(m1, jm1, sam1, jam1,
     file = "FinalResults/Jams/cerwm1jam.RData")

pdf("FinalResults/Plots/cerwm1cov.pdf")
plot(jam1, pages=1)
dev.off()


##Model 2: cerw (no eBird filtering)
#train: eBird- 1:20361, BBA- 20362:47364, BBS- 47365:80041
#test: eBird- 80042:89258, BBA- 89259:95988, BBS- 95989:104261

m2 <- jagam(cerwdet ~ s(elev, k=10) + s(slope, k=10) + s(temp, k=10) + s(ppt, k=10) + s(can, k=10) + s(dev, k=10) + 
              s(forest, k=10) + s(road, k=10) + s(longitude, latitude, bs='ds', k=100), 
            data = dat2, family='binomial', file = 'placeholder.txt')

datm2 <- list(y = c(dat2$cerwdet[1:20361], dat2$cerwtot[20362:47364], dat2$cerwdet[47365:80041]), 
...
outm2 <- jags(data = datm2, parameters.to.save = c("beta","b","y2"), inits = initsm2, 
              model.file = "FinalModels/cerwm2.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)

#Full Deviance
m2_yp <- outm2$mean$y2
m2_yt <- c(dat2$cerwdet[80042:89258], dat2$cerwtot[89259:95988], dat2$cerwdet[95989:104261])
m2_yt <- cbind(m2_yt, c(1 - dat2$cerwdet[80042:89258], 5 - dat2$cerwtot[89259:95988], 1 - dat2$cerwdet[95989:104261]))
...
Em2_yt <- c(dat2$cerwdet[80042:89258])
Em2_yt <- cbind(Em2_yt, c(1 - dat2$cerwdet[80042:89258]))
Em2_yp <- 0.0001 + Em2_yp*0.9998
Em2_dev <- -2*sum(log((Em2_yp^Em2_yt[,1])*((1-Em2_yp)^(Em2_yt[,2]))))
#BBA deviance
Am2_yp <- outm2$mean$y2[9218:15947]
Am2_yt <- c(dat2$cerwtot[89259:95988])
Am2_yt <- cbind(Am2_yt, c(5 - dat2$cerwtot[89259:95988]))
Am2_yp <- Am2_yp/5
Am2_yp <- 0.0001 + Am2_yp*0.9998
Am2_dev <- -2*sum(log((Am2_yp^Am2_yt[,1])*((1-Am2_yp)^(Am2_yt[,2]))))
#BBS deviance
Sm2_yp <- outm2$mean$y2[15948:24220]
Sm2_yt <- c(dat2$cerwdet[95989:104261])
Sm2_yt <- cbind(Sm2_yt, c(1 - dat2$cerwdet[95989:104261]))
...
save(outm2, m2, m2_dev, Em2_dev, Am2_dev, Sm2_dev, 
     file = "FinalResults/cerwm2.RData")

brier2 <- mean((outm2$mean$y2[9218:24220] - dat2$cerwdet[89259:104261])^2)

pred2 <- prediction(as.numeric(outm2$mean$y2[9218:24220]), dat2$cerwdet[89259:104261])
auc2 <- performance(pred2, measure = "auc")
auc2 <- auc2@y.values[[1]]



##Model 3: cerw (no eBird spatial balancing)
#train: eBird- 1:111728, BBA- 111729:138731, BBS- 138732:171408
#test: eBird- 171409:180625, BBA- 180626:187355, BBS- 187356:195628

m3 <- jagam(cerwdet ~ s(elev, k=10) + s(slope, k=10) + s(temp, k=10) + s(ppt, k=10) + s(can, k=10) + s(dev, k=10) + 
              s(forest, k=10) + s(road, k=10) + s(longitude, latitude, bs='ds', k=100), 
...
outm3 <- jags(data = datm3, parameters.to.save = c("beta","b","y2"), inits = initsm3, 
              model.file = "FinalModels/cerwm3.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)
...
save(outm3, m3, m3_dev, Em3_dev, Am3_dev, Sm3_dev, 
     file = "FinalResults/cerwm3.RData")
...
##Model 4: cerw (no eBird filtering or spatial balancing)
#train: eBird- 1:117936, BBA- 117937:144939, BBS- 144940:177616
#test: eBird- 177617:186833, BBA- 186834:193563, BBS-193564:201836

m4 <- jagam(cerwdet ~ s(elev, k=10) + s(slope, k=10) + s(temp, k=10) + s(ppt, k=10) + s(can, k=10) + s(dev, k=10) + 
              s(forest, k=10) + s(road, k=10) + s(longitude, latitude, bs='ds', k=100), 
...
outm4 <- jags(data = datm4, parameters.to.save = c("beta","b","y2"), inits = initsm4, 
              model.file = "FinalModels/cerwm4.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)
...
save(outm4, m4, m4_dev, Em4_dev, Am4_dev, Sm4_dev, 
     file = "FinalResults/cerwm4.RData")
...
##Model 5: cerw (no eBird effort)
#train: eBird- 1:19829, BBA- 19830:46832, BBS- 46833:79509
#test: eBird- 79510:88726, BBA- 88727:95456, BBS- 95457:103729

m5 <- jagam(cerwdet ~ s(elev, k=10) + s(slope, k=10) + s(temp, k=10) + s(ppt, k=10) + s(can, k=10) + s(dev, k=10) + 
              s(forest, k=10) + s(road, k=10) + s(longitude, latitude, bs='ds', k=100), 
            data = dat1, family='binomial', file = 'placeholder.txt')

datm5 <- list(y = c(dat1$cerwdet[1:19829], dat1$cerwtot[19830:46832], dat1$cerwdet[46833:79509]), 
...
outm5 <- jags(data = datm5, parameters.to.save = c("beta","b","y2"), inits = initsm5, 
              model.file = "FinalModels/cerwm5.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)

#Full Deviance
m5_yp <- outm5$mean$y2
m5_yt <- c(dat1$cerwdet[79510:88726], dat1$cerwtot[88727:95456], dat1$cerwdet[95457:103729])
m5_yt <- cbind(m5_yt, c(1 - dat1$cerwdet[79510:88726], 5 - dat1$cerwtot[88727:95456], 1 - dat1$cerwdet[95457:103729]))
...
Em5_yt <- c(dat1$cerwdet[79510:88726])
Em5_yt <- cbind(Em5_yt, c(1 - dat1$cerwdet[79510:88726]))
Em5_yp <- 0.0001 + Em5_yp*0.9998
Em5_dev <- -2*sum(log((Em5_yp^Em5_yt[,1])*((1-Em5_yp)^(Em5_yt[,2]))))
#BBA deviance
Am5_yp <- outm5$mean$y2[9218:15947]
Am5_yt <- c(dat1$cerwtot[88727:95456])
Am5_yt <- cbind(Am5_yt, c(5 - dat1$cerwtot[88727:95456]))
Am5_yp <- Am5_yp/5
Am5_yp <- 0.0001 + Am5_yp*0.9998
Am5_dev <- -2*sum(log((Am5_yp^Am5_yt[,1])*((1-Am5_yp)^(Am5_yt[,2]))))
#BBS deviance
Sm5_yp <- outm5$mean$y2[15948:24220]
Sm5_yt <- c(dat1$cerwdet[95457:103729])
Sm5_yt <- cbind(Sm5_yt, c(1 - dat1$cerwdet[95457:103729]))
...
save(outm5, m5, m5_dev, Em5_dev, Am5_dev, Sm5_dev, 
     file = "FinalResults/cerwm5.RData")

brier5 <- mean((outm5$mean$y2[9218:24220] - dat1$cerwdet[88727:103729])^2)

pred5 <- prediction(as.numeric(outm5$mean$y2[9218:24220]), dat1$cerwdet[88727:103729])
auc5 <- performance(pred5, measure = "auc")
auc5 <- auc5@y.values[[1]]



##Model 6: cerw (no filtering, no spatial balancing, & no effort for eBird)
#train: eBird- 1:117936, BBA- 117937:144939, BBS- 144940:177616
#test: eBird- 177617:186833, BBA- 186834:193563, BBS- 193564:201836

m6 <- jagam(cerwdet ~ s(elev, k=10) + s(slope, k=10) + s(temp, k=10) + s(ppt, k=10) + s(can, k=10) + s(dev, k=10) + 
              s(forest, k=10) + s(road, k=10) + s(longitude, latitude, bs='ds', k=100), 
            data = dat4, family='binomial', file = 'placeholder.txt')
...
outm6 <- jags(data = datm6, parameters.to.save = c("beta","b","y2"), inits = initsm6, 
              model.file = "FinalModels/cerwm6.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)
...
save(outm6, m6, m6_dev, Em6_dev, Am6_dev, Sm6_dev, 
     file = "FinalResults/cerwm6.RData")
...
#Model 7: cerw (full model + false pos for eBird)
#train: eBird- 1:19829, BBA- 19830:46832, BBS- 46833:79509
#test: eBird- 79510:88726, BBA- 88727:95456, BBS- 95457:103729

m7 <- jagam(cerwdet ~ s(elev, k=10) + s(slope, k=10) + s(temp, k=10) + s(ppt, k=10) + s(can, k=10) + s(dev, k=10) + 
              s(forest, k=10) + s(road, k=10) + s(longitude, latitude, bs='ds', k=100), 
            data = dat1, family='binomial', file = 'placeholder.txt')

datm7 <- list(y = c(dat1$cerwdet[1:19829], dat1$cerwtot[19830:46832], dat1$cerwdet[46833:79509]), 
...
outm7 <- jags(data = datm7, parameters.to.save = c("beta","b","y2", "f"), inits = initsm7, 
              model.file = "FinalModels/cerwm7.txt", 
              n.chains = 3, n.thin = 2, n.adapt = 500, n.burnin = 500, n.iter = 2500)
...
Em7_yt <- c(dat1$cerwdet[79510:88726])
Em7_yt <- cbind(Em7_yt, c(1 - dat1$cerwdet[79510:88726]))
Em7_yp <- 0.0001 + Em7_yp*0.9998
Em7_dev <- -2*sum(log((Em7_yp^Em7_yt[,1])*((1-Em7_yp)^(Em7_yt[,2]))))
#BBA deviance
Am7_yp <- outm7$mean$y2[9218:15947]
Am7_yt <- c(dat1$cerwtot[88727:95456])
Am7_yt <- cbind(Am7_yt, c(5 - dat1$cerwtot[88727:95456]))
Am7_yp <- Am7_yp/5
Am7_yp <- 0.0001 + Am7_yp*0.9998
Am7_dev <- -2*sum(log((Am7_yp^Am7_yt[,1])*((1-Am7_yp)^(Am7_yt[,2]))))
#BBS deviance
Sm7_yp <- outm7$mean$y2[15948:24220]
Sm7_yt <- c(dat1$cerwdet[95457:103729])
Sm7_yt <- cbind(Sm7_yt, c(1 - dat1$cerwdet[95457:103729]))
...
save(outm7, m7, m7_dev, Em7_dev, Am7_dev, Sm7_dev, 
     file = "FinalResults/cerwm7.RData")

brier7 <- mean((outm7$mean$y2[9218:24220] - dat1$cerwdet[88727])^2)

pred7 <- prediction(as.numeric(outm7$mean$y2[9218:24220]), dat1$cerwdet[88727:103729])
...
#Plot
pdf("FinalResults/Plots/cerwm1map.pdf")
