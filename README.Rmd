...
**Integrating unreliable data into species distribution models to improve occupancy predictions of avian species of concern** 

Authors: Fiona Lunt, C. Lane Scher, Riley O. Mummah, and David A.W. Miller. 

The code and data are maintained by [`r params$maintainer1`](mailto: `r params$maintainer_email1`). All code was run using R version 4.2.1 and JAGS 4.3.1
